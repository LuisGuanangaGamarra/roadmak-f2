<?php /* Smarty version Smarty-3.1.19, created on 2020-11-17 12:24:16
         compiled from "C:\laragon\www\roadmakshop\themes\classic\templates\_partials\form-fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10367485075fb4074034d660-22184802%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '647bf0f8ae7fd46290215c5e6f7dddcd17247106' => 
    array (
      0 => 'C:\\laragon\\www\\roadmakshop\\themes\\classic\\templates\\_partials\\form-fields.tpl',
      1 => 1605544143,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10367485075fb4074034d660-22184802',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fb4074038b8e9_07525103',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb4074038b8e9_07525103')) {function content_5fb4074038b8e9_07525103($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_select_date')) include 'C:\\laragon\\www\\roadmakshop\\vendor\\prestashop\\smarty\\plugins\\function.html_select_date.php';
?>
...
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['name'], ENT_QUOTES, 'UTF-8');?>
<?php $_tmp4=ob_get_clean();?><?php ob_start();?><?php echo smartyTranslate(array('s'=>'-- day --','d'=>'Shop.Forms.Labels'),$_smarty_tpl);?>
<?php $_tmp5=ob_get_clean();?><?php ob_start();?><?php echo smartyTranslate(array('s'=>'-- month --','d'=>'Shop.Forms.Labels'),$_smarty_tpl);?>
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo smartyTranslate(array('s'=>'-- year --','d'=>'Shop.Forms.Labels'),$_smarty_tpl);?>
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars(date('Y'), ENT_QUOTES, 'UTF-8');?>
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars(date('Y'), ENT_QUOTES, 'UTF-8');?>
<?php $_tmp9=ob_get_clean();?><?php echo smarty_function_html_select_date(array('field_order'=>'DMY','time'=>$_tmp3,'field_array'=>$_tmp4,'prefix'=>false,'reverse_years'=>true,'field_separator'=>'<br>','day_extra'=>'class="form-control form-control-select"','month_extra'=>'class="form-control form-control-select"','year_extra'=>'class="form-control form-control-select"','day_empty'=>$_tmp5,'month_empty'=>$_tmp6,'year_empty'=>$_tmp7,'start_year'=>$_tmp8-100,'end_year'=>$_tmp9),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('_partials/form-errors.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('errors'=>$_smarty_tpl->tpl_vars['field']->value['errors']), 0, '10367485075fb4074034d660-22184802');
content_5fb40740384511_73207755($_smarty_tpl);
...
<?php if ($_valid && !is_callable('content_5fb40740384511_73207755')) {function content_5fb40740384511_73207755($_smarty_tpl) {?>
