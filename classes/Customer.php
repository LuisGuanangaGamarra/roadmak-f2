...
/*$client = new Client([
    ...
    'base_uri' => 'http://localhost:3988/api/register_prestashop',
    // You can set any number of default request options.
    'timeout'  => 2.0,
]);

$response = $client->request('POST', 'http://localhost:3988/api/register_prestashop', [
    'form_params' => [
...
//$variable_query= "firstname="+$this->firstname+"&lastname="+$this->lastname+"&email="+$this->email+"&passwd="+$this->passwd+"";
...
curl_setopt_array($curl, array(
  CURLOPT_PORT          => "3988",
  CURLOPT_URL           => "http://localhost:3988/api/register_prestashop",
  ...
  CURLOPT_POSTFIELDS    => "firstname=".$this->firstname."&lastname=".$this->lastname."&email=".$this->email."&passwd=".$this->passwd."",
  CURLOPT_HTTPHEADER => array(
    "Content-Type: application/x-www-form-urlencoded",
    "Postman-Token: 874d63f7-230c-436f-9a82-811ba344444c",
...
$request->setUrl('http://localhost:3988/api/register_prestashop');
$request->setMethod(HTTP_METH_POST);

$request->setHeaders(array(
  'Postman-Token' => '5944532c-9796-47ae-b4ee-2b1269b48ea4',
  'cache-control' => 'no-cache',
  'Content-Type' => 'application/x-www-form-urlencoded'
));
...
/*var_dump($this->firstname);
 ...
 var_dump($this->id_shop);
 var_dump($this->secure_key);
 var_dump($this->last_passwd_gen);*/
